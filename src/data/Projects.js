const projects = [
  {
    id: 1,
    title: "Poovizhi Farms – E-Commerce Platform",
    description: "Full-stack organic product store built with MERN stack featuring JWT authentication, admin dashboard, Razorpay payments, and responsive design with product filtering.",
    image: "/assets/images/poovizhi-farms.svg",
    technologies: ["React", "Node.js", "MongoDB", "Express", "JWT", "Razorpay"],
    githubUrl: "https://github.com/ShobiyaKavinraj/poovizhi-farms",
    liveUrl: "https://poovizhi-farms-frontend.vercel.app",
    featured: true
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description: "A modern React.js portfolio website with routing featuring pages for About, Projects, Resume, and Contact with beautiful animations and responsive design.",
